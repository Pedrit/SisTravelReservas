...
public interface IUsuarioService {
	...
	/**
	 * Lista Todas las Personas Registradas para esa Empresa.
	 * @param Usuario codigo de empresa.
	 * @param bean objeto que contiene el codigo de empresa.
	 * @return Login, Lista de personas encontrados.
	 * @author PROMERO
	 */
	List<SgMaePersona> obtenerPersonas(Usuario bean);
	 ...
	 */
	String editarPersona(Usuario bean);
	 ...
	 * @return String, mensaje de trasaccion realizada o error.
	 */
	String editarEstadoUsuario(Usuario bean);
